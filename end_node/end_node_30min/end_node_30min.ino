...
void setup()
{
    ...
    while (gps_fix == 0){
        ...
        if (GPS.newNMEAreceived()){
            ...
            if (GPS.fix){
                GPS_charCount = sprintf(GPS_logData, "%.4f,%.4f,%d", GPS.latitudeDegrees, GPS.longitudeDegrees, GPS_altitude);
                gps_fix = 1;
                GPS_sleep();
            }
        }
    ...
    rtcZero.setAlarmMinutes((rtcZero.getAlarmMinutes() + 30) % 60);
